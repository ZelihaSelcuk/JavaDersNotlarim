...
public class C05_WhileLoop {
    public static void main(String[] args) {
        ...
        while(!sifreKontrolEt(sifre)){   //whileloop body si şifre başarılı olmadıgı müddetçe çalışmaya devam edecek.
            // sifre true donerse loop'un bitmesi icin basina ! yazdik
            ...
            // soru daha önce çözülmüştü çünkü aşağıda yorumda var.
