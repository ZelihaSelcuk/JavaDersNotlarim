package deneme.day18_parametrizedConstructor_constructorCall;
...
public class C02_CarRunner {
    ...
    public static void main(String[] args) {
        ...
        C01_Car car5 = new C01_Car("audi","a5","siyah");
        System.out.println(car5);

        C01_Car car6 = new C01_Car("Mercedes","c200","beyaz",5);
        System.out.println(car6);

        C01_Car car7 = new C01_Car("corolla",5);
